...
class playfairCipher
{
	...
	public static void main(String[] args)
	{
		...
		String key="CSE";
		String txt="SecurityLab";/*make sure string length is even*/
		/*change J to I*/
		boolean chgJtoI = true;
		obj.createTbl(key,chgJtoI);
		String enc = encode(obj.prepareText(txt, chgJtoI));
		System.out.println("SimulatingPlayfairCipher\n	");
		System.out.println("Input Message : " + txt);
		System.out.println("Encrypted Message : " + enc);
		System.out.println("DecryptedMessage:"+obj.decode(enc));
	}
}
